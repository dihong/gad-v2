...
if __name__ == '__main__':
    ...
    features = tf.concat(2, continuous_features.values() + embeddings.values(), name='features')

    # split into a list along time dimension
    input_features = tf.unpack(features)
    ...
    hidden_matrix = tf.concat(0, hidden_states)

...
def run_svm_test(args):
    ...
    outfile_path1 = os.path.join(outdir, 'train', outfile_name)
    outfile_path2 = os.path.join(outdir, 'test', outfile_name)
...
def run_dnn_test(args):
    ...
    train_rst, test_rst = split_train_test(rst)
    outfile1 = os.path.join(outdir, 'train', 'dnn__nl_{}__hs_{}.txt'.format(nl,hs))
    outfile2 = os.path.join(outdir, 'test', 'dnn__nl_{}__hs_{}.txt'.format(nl,hs))
    save_rst(train_rst, outfile1)
    save_rst(test_rst, outfile2)
    print('')
